...
export const { loadTags, removeTags, setColor, removeAllTags, setAllTags, setShowEditor, setEditNote, setShowFilter, loadFilter, setLabel, setSearchFilter } = notesSlice.actions;
